// Browser Console Debug Script for Recipe Update - FIXED VERSION
// Copy and paste this entire script into your browser's developer console

console.log('🔍 Recipe Update Debug Script Starting (Fixed Version)...');
...
// Function to get auth token from localStorage - FIXED VERSION
function getAuthToken() {
  // Check for accessToken first (your app's actual token key)
...
console.log('  inspectLocalStorage() - Show all localStorage data');
console.log('  getUserInfo() - Show user information');

// Auto-run inspection first
console.log('\n🔍 Auto-running localStorage inspection...');
inspectLocalStorage();
getUserInfo();
